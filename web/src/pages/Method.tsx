    ...
    <div className="page">
      <div className="prose">
        ...
        <ul>
          ...
          <li><b>Single tender</b>: share of competitive lots with a known tender count that received exactly one tender. <b>Competitive</b> excludes direct awards, where a single offer is the normal case.</li>
          <li><b>Direct award</b> (no call for competition): share of awarded lots from a negotiated procedure without prior publication. The buyer publishes no contract notice and negotiates with one or a few companies it selects itself. Above the EU thresholds this is allowed only on specific grounds: only one possible supplier (technical reasons, exclusive rights), extreme urgency not caused by the buyer, no suitable tenders in an earlier open procedure, or additional work foreseen in the original contract. Only direct awards reported afterwards on TenderNed (award notice or voluntary transparency notice) are visible; most below-threshold direct awards are never published.</li>
